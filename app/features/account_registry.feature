Feature: Account registry
 ...
 Scenario: User is able to create a second account
   ...
   When I create an account using name: "jack", last name: "jawor", pesel: "89091209876"
 ...
 Scenario: User is able to update last name saved in account
   ...
   When I update last name in account with pesel "89091209876" to "Kowalski"
   Then Last name in account with pesel "89091209876" is "Kowalski"
